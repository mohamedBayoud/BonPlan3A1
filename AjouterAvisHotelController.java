 ...
 * @author Omar
 */
public class AjouterAvisHotelController implements Initializable {
	...
	private void ButtonAjouter(ActionEvent event) throws SQLException, IOException {
		...
		PartageHotel v = new PartageHotel(CommentaireField.getText(),a, b, c, d, java.sql.Date.valueOf(LocalDate.now()));
		if ((a >= 0 && a <= 5) && (b >= 0 && b <= 5) && (c >= 0 && c <= 5) && (d >= 0 && d <= 5)) {
			sv.AjouterAvisHotel(v);
	...
	public int Rating1()
	{
		...
		etoilevide3.setOnMouseClicked((javafx.scene.input.MouseEvent E1) -> {
           ...
           etoilevide3.setOnMouseExited((javafx.scene.input.MouseEvent E2) -> {
		...
		etoilevide4.setOnMouseClicked((javafx.scene.input.MouseEvent E1) -> {
			...
			etoilevide2.setAccessibleText("touche pas");
			etoilevide3.setAccessibleText("touche pas");
		    etoilevide4.setAccessibleText("touche pas");
