...
public class Sejourner extends BP {
    ...
    public Sejourner (){}
    public Sejourner(String nom,String photo,String description,String adresse,String ville,/* int valide*/ int nbreChambreDispo, int prixnuit) {
        super(nom, photo, description, adresse, ville /* valide*/);
