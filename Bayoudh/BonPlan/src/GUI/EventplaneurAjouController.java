...
public class EventplaneurAjouController implements Initializable {
    ...
    private void AjoutEvent(ActionEvent event) throws SQLException, IOException {
        ...
        if ((titre.getText().isEmpty()) && (lieu.getText().isEmpty()) && (description.getText().isEmpty()) && (nbplace.getText().isEmpty()) && (prix.getText().isEmpty()) && (ComboType.getValue().isEmpty()) && (imagetelecharger.getItems().isEmpty())) {

            Image o = new Image("/View/Cross.png");
